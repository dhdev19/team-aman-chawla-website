...
export default function AddVideoPage() {
  ...
  }, [videoLink, setValue, uploadedThumbnail]);
  ...
  const onSubmit = async (data: VideoFormData) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        alert(response.error || "Failed to create video");
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-neutral-600">Create a new video listing</p>
      </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  {autoThumbnail && !uploadedThumbnail && (
                    <div className="mt-2">
                  ...
                  {!uploadedThumbnail && !autoThumbnail && (
